...
# writer_new.py 是一个 Python 脚本，它用于将内部模型字典转换为 PDDL（Planning Domain Definition Language）格式的文件。
# TODO: Add Conditional Effects
# TODO: Add increase effects

class ModelWriter(object):
    def __init__(self, model, domain_name="test_domain.pddl", problem_name="instance-1"):
    ...
    # def __init__(self, model, domain_name="test_domain.pddl", problem_name="instance-12.pddl"):
    #     self.model_dict = model
    #     self.predicate_map = {}
    #     self.functions = {}
    #     self.variable_map = {}
    ...
    #     curr_writer = FstripsWriter(self.fstrips_problem)
    #     curr_writer.write(self.domain_name, self.problem_name)